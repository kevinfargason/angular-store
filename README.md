...
You need git to clone the angular-store repository. You can get git from
[http://git-scm.com/](http://git-scm.com/).

It also uses a number of node.js tools to initialize and test angular-store. You must have node.js and
...
There are two kinds of tests in the angular-store application: Unit tests and End to End tests.

### Running Unit Tests

The angular-store app comes preconfigured with unit tests. These are written in
...
The angular-store app comes with end-to-end tests, again written in [Jasmine][jasmine]. These tests
...
In addition, since Protractor is built upon WebDriver we need to install this.  The angular-store
...
Previously we recommended that you merge in changes to angular-store into your own fork of the project.
...
The angular-store project supports loading the framework and application scripts asynchronously.  The
...
The angular-store project comes preconfigured with a local development webserver.  It is a node.js
...
to your repository and execute scripts such as building the app or running tests. The angular-store
